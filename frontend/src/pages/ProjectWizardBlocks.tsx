...
const ProjectWizardBlocks = () => {
    const { getEmptyHouseBlock, refresh, nonFixedCustomDefinitions } = useContext(HouseBlockContext);
    ...
    const validateHouseBlock = (houseBlock: HouseBlockWithCustomProperties, selectedProject: Project, index: number) => {
        ...
        if (isHouseBlockInvalid(houseBlock, invalidOwnershipAmount, nonFixedCustomDefinitions)) {
            hasErrors = true;
        }
