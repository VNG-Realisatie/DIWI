...
export const MutationKindSelect = ({ projectForm, setProjectForm, edit, editForm }: MutationInformationProps) => {
    return (
        <Stack>
            ...
            {!edit && editForm && (
                <InputContainer>
                    <Typography>{projectForm?.mutation?.mutationKind?.join(",")}</Typography>
                </InputContainer>
            )}
            {!edit && !editForm && (
                <Select
