...
export const OrdinalCategoryCreateOption: React.FC<Props> = ({ categoryValue, setCategoryValue }) => {
    ...
    const handleRemoveCategory = (index: number) => {
        let updatedCategories = hasLevels ? [...categoryValue] : [...categoryValue].sort(sortCategories);
        let categoriesDisabledAmount = categoryValue.filter((c) => c.disabled === true).length;
