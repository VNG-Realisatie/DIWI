...
export const ProjectHouseBlockCardItem=(props:any)=>{
   ...
   return <>
                                ...
                                >
                                      {hb.naam?hb.naam:"Geen Naam"}{<Box sx={{cursor:"pointer"}}>{editable?<SaveIcon onClick={()=>setEditable(false)}/>:<EditIcon onClick={()=>setEditable(true)}/>}</Box>}
                                </Grid>
                                <Grid item sm={2}>
                                    <Typography
                                        sx={columnTitleStyle}
                                ...
                                <Grid item sm={3}>
                                    ...
                                    >
                                        {hb.wijk}
                                    </Typography>:<TextField fullWidth size="small" id="outlined-basic"  variant="outlined" />}
                                </Grid>
                                <Grid item sm={3}>
                                    <Typography
                                        sx={columnTitleStyle}
