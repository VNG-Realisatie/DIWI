...
export async function putCustomPropertyValue(id: string, newData: CustomPropertyValue): Promise<any> {
...
export async function putBlockCustomPropertyValue(id: string, newData: CustomPropertyValue): Promise<any> {
