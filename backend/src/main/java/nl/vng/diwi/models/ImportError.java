...
public class ImportError {
    ...
    public enum ERROR {
        ...
        UNKNOWN_PRICE_BUY_RANGE_CATEGORY("unknown_price_buy_range_category", "The fixed property priceRangeBuy does not have a range category option with this name."),
        UNKNOWN_PRICE_RENT_RANGE_CATEGORY("unknown_price_rent_range_category", "The fixed property priceRangeRent does not have a range category option with this name."),
        ...
        HOUSEBLOCK_OWNERSHIP_INCONSISTENT("houseblock_ownership_multiple_types", "The houses in must be expressed either as range or as a category"),
        HOUSEBLOCK_OWNERSHIP_OWNER_INCONSISTENT("houseblock_ownership_owner_multiple_types", "The houses in Home-value section must all be expressed either as range or as a category"),
        HOUSEBLOCK_OWNERSHIP_LANDLORD_INCONSISTENT("houseblock_ownership_landlord_multiple_types", "The houses in Rental-price-private-landlord section must all be expressed either as range or as a category"),
        HOUSEBLOCK_OWNERSHIP_HOUSING_ASSOCIATION_INCONSISTENT("houseblock_ownership_housing_assoc_multiple_types", "The houses in Housing-association-rental-price section must all be expressed either as range or as a category"),
