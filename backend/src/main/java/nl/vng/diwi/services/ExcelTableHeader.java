...
public class ExcelTableHeader {
    ...
    public enum Column {
        ...
        PROJECT_PLAN_STATUS_4A_OPGENOMEN_IN_VISIE("4a Niet opgenomen in de visie", false),
        PROJECT_PLAN_STATUS_4B_NIET_OPGENOMEN_IN_VISIE("4b Opgenomen in de visie", false),
        ...
        //TODO: eigendom & waarde
        HOUSEBLOCK_PROPERTY_PURCHASE_PRICE("Koopprijs categorie", true),
        HOUSEBLOCK_PROPERTY_LANDLORD_RENTAL_PRICE("Huurprijs particulier", true),
        ...
        HOUSEBLOCK_TYPE_UNKNOWN("Onbekend woning", false),
